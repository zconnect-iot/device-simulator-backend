...
def door_position_input(door_position_now, people_waiting, bearing_condition,
    ...
    if not util.within_top_margin(0, 5, 0.02, current_in):
...
def current_in_inputs(door_position, people_waiting):
    ...
    door_should_open = people_waiting\
        and not util.within_top_margin(0, 10, 0.05, door_position)
    door_should_close = not people_waiting\
        and not util.within_bottom_margin(0, 10, 0.05, door_position)
